...
import com.example.transcriber.backup.fingerprint.FingerprintSegment
import com.example.transcriber.backup.fingerprint.TranscriptFingerprint
import com.example.transcriber.backup.settings.PortableSettingsRestorer
...
class RestoreCoordinator(
    ...
    private suspend fun importTranscripts(
        zip: ZipFile,
        dao: com.example.transcriber.data.database.BackupDao,
        plan: RestorePlan,
        idMap: RestoreIdMap,
