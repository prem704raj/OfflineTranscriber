...
import app.offlinetranscriber.mobile.shortcuts.ExternalAppCommand
import app.offlinetranscriber.mobile.ui.about.AboutScreen
import app.offlinetranscriber.mobile.ui.accessibility.minimumTouchTarget
import app.offlinetranscriber.mobile.ui.detail.TranscriptDetailScreen
import app.offlinetranscriber.mobile.ui.diagnostics.DiagnosticsScreen
import app.offlinetranscriber.mobile.ui.home.HomeScreen
import app.offlinetranscriber.mobile.ui.home.HomeViewModel
import app.offlinetranscriber.mobile.ui.layout.AppWidthClass
import app.offlinetranscriber.mobile.ui.layout.appWidthClass
import app.offlinetranscriber.mobile.ui.library.CollectionDetailScreen
import app.offlinetranscriber.mobile.ui.library.LibraryScreen
import app.offlinetranscriber.mobile.ui.modelmanager.ModelManagerScreen
import app.offlinetranscriber.mobile.ui.onboarding.OnboardingScreen
import app.offlinetranscriber.mobile.ui.paywall.PaywallScreen
import app.offlinetranscriber.mobile.ui.privacy.PrivacyDataScreen
import app.offlinetranscriber.mobile.ui.queue.QueueScreen
import app.offlinetranscriber.mobile.ui.search.SearchScreen
import app.offlinetranscriber.mobile.ui.settings.SettingsScreen
import app.offlinetranscriber.mobile.ui.study.StudyScreen
import app.offlinetranscriber.mobile.ui.subtitle.SubtitleStudioScreen
import app.offlinetranscriber.mobile.ui.video.VideoImportScreen
import app.offlinetranscriber.mobile.ui.record.RecordScreen
import app.offlinetranscriber.mobile.ui.ask.AskScreen
import app.offlinetranscriber.mobile.ui.meeting.MeetingInsightsScreen
import app.offlinetranscriber.mobile.ui.speaker.SpeakerScreen
import app.offlinetranscriber.mobile.ui.speaker.SpeakerViewModel
import app.offlinetranscriber.mobile.ui.export.ExportHubScreen
import app.offlinetranscriber.mobile.ui.backup.BackupViewModel
import app.offlinetranscriber.mobile.ui.backup.BackupRestoreScreen
import app.offlinetranscriber.mobile.ui.backup.CreateBackupScreen
import app.offlinetranscriber.mobile.ui.backup.RestorePreviewScreen
        ...
        NavDisplay(
            ...
            entryProvider = entryProvider {
                ...
                entry<RecordNavKey> {
                    RecordScreen(
                        onBack = { backStack.removeLastOrNull() },
                        onTranscribe = { recordedFile: java.io.File ->
                            val uri = Uri.fromFile(recordedFile)
                            homeViewModel.enqueueAudio(uri)
                ...
                entry<SpeakerNavKey> { key ->
                    val appContext = androidx.compose.ui.platform.LocalContext.current.applicationContext as TranscriberApplication
                    val viewModel: SpeakerViewModel = androidx.lifecycle.viewmodel.compose.viewModel {
                        SpeakerViewModel(appContext, key.transcriptId)
                    }
                    SpeakerScreen(
                        viewModel = viewModel,
                        onBack = { backStack.removeLastOrNull() },
