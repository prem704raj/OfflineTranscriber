...
class BackupRestoreForegroundService : Service() {
    ...
    companion object {
        const val ACTION_CREATE = "app.offlinetranscriber.mobile.backup.ACTION_CREATE"
        const val ACTION_INSPECT = "app.offlinetranscriber.mobile.backup.ACTION_INSPECT"
        const val ACTION_RESTORE = "app.offlinetranscriber.mobile.backup.ACTION_RESTORE"
        const val ACTION_CANCEL = "app.offlinetranscriber.mobile.backup.ACTION_CANCEL"
