package app.offlinetranscriber.mobile.speaker
...
import app.offlinetranscriber.mobile.processing.HeavyAudioMlArbiter
import app.offlinetranscriber.mobile.processing.HeavyMlTaskType
import app.offlinetranscriber.mobile.speaker.alignment.SegmentSpeakerAligner
import app.offlinetranscriber.mobile.speaker.audio.DiarizationWindowPolicy
import app.offlinetranscriber.mobile.speaker.audio.Pcm16WindowReader
import app.offlinetranscriber.mobile.speaker.audio.PreparedAudioResult
import app.offlinetranscriber.mobile.speaker.audio.SpeakerAudioPreparer
import app.offlinetranscriber.mobile.speaker.engine.WindowedSpeakerDiarizer
...
import app.offlinetranscriber.mobile.speaker.modelmanager.SpeakerModelCatalog
import app.offlinetranscriber.mobile.speaker.modelmanager.SpeakerModelManager
import app.offlinetranscriber.mobile.speaker.persistence.SpeakerNamePreserver
import app.offlinetranscriber.mobile.speaker.repository.SpeakerDiarizationRepository
...
class SpeakerDiarizationCoordinator(
    ...
    suspend fun runDiarization(
        ...
        // 1. Pro check
        if (!app.offlinetranscriber.mobile.billing.FeatureAccessPolicy.hasAccess(billingRepository.state.value.entitlement, ProFeature.SPEAKER_INTELLIGENCE)) {
