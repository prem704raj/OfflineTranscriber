...
class SpeakerDiarizationForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START_DIARIZATION = "app.offlinetranscriber.mobile.action.START_SPEAKER_DIARIZATION"
        const val ACTION_CANCEL = "app.offlinetranscriber.mobile.action.CANCEL_SPEAKER_DIARIZATION"
