...
class TranscriptionForegroundService : Service() {
    ...
    companion object {
        const val ACTION_DRAIN_QUEUE = "app.offlinetranscriber.mobile.action.DRAIN_QUEUE"
        const val ACTION_CANCEL_CURRENT = "app.offlinetranscriber.mobile.action.CANCEL_CURRENT"
    }
